...
{
    //selecting file based on input
    char filename[20];
    switch (tsno)
    {
    case 1:
        strcpy(filename,"data/pinfo-t1.txt");
        break;
    case 2:
        strcpy(filename,"data/pinfo-t2.txt");
        break;
    case 3:
        strcpy(filename,"data/pinfo-t3.txt");
        break;
    case 4:
        strcpy(filename,"data/pinfo-t4.txt");
        break;
    case 5:
        strcpy(filename,"data/pinfo-t5.txt");
        break;
    case 6:
        strcpy(filename,"data/pinfo-t6.txt");
        break;
    case 7:
        strcpy(filename,"data/pinfo-t7.txt");
        break;
    default:
        break;
    }
...
else
{
	...
	int i=0,charge;// ,fgo,fpra,fluc,fmew,fjab,fsha,fdur,fpp,time,sgo,spra,sluc,smew,sjab,ssha,sdur,seats,pnr;
	char confirm;
	float charges;
	pd passdetails;
	FILE *fp;
...
fp=fopen("data/tinfo.txt","r");
int l=0,tk=0,sn;//line count, token count and serial number of trains
char line[200];
...
//selecting file based on user input
char filename[20];

switch (passdetails.train_num)
{
    case 2420:
        strcpy(filename,"data/pinfo-t1.txt");
        sn=1;
